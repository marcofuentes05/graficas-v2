"""
AABB.py
Clase AABB usada en RayTracer para modelar una Axis Adjacent Bounding Box
"""
from Plane import *
...
class AABB(object):
    def __init__(self, position, size, material):
        ...
        self.planes.append( Plane( sumarVectores(position, V3(halfSizeX,0,0)), V3(1,0,0), material))
        self.planes.append( Plane( sumarVectores(position, V3(-halfSizeX,0,0)), V3(-1,0,0), material))

        self.planes.append( Plane( sumarVectores(position, V3(0,halfSizeY,0)), V3(0,1,0), material))
        self.planes.append( Plane( sumarVectores(position, V3(0,-halfSizeY,0)), V3(0,-1,0), material))

        self.planes.append( Plane( sumarVectores(position, V3(0,0,halfSizeZ)), V3(0,0,1), material))
        self.planes.append( Plane( sumarVectores(position, V3(0,0,-halfSizeZ)), V3(0,0,-1), material))
