...
# r.scene.append( Sphere(V3( 0, -2, -8), 2, sun) )
# r.scene.append( Sphere(V3( 0, 2, -8), 2, earthMat) )
...
r.scene.append( AABB(V3(0   ,  2  , -10 ) , V3(5, 0.1, 5) , boxMat ) )

r.scene.append( AABB(V3(-2.5, -0.5, -10 ) , V3(0.1, 5, 5) , boxMat ) )
r.scene.append( AABB(V3(2.5 , -0.5, -10 ) , V3(0.1, 5, 5) , boxMat ) )

r.scene.append( AABB(V3(0   ,-0.5 ,-12.5) , V3(5,5,0.5) , boxMat))
# r.scene.append( AABB(V3(0, -3, -10), V3(5, 0.1, 5) , boxMat ) )
# r.scene.append( AABB(V3(0, -3, -10), V3(5, 0.1, 5) , boxMat ) )
